    ...
    return (
      <div className="TotalNumbers">
        <div className="TotalNumebrs__container container">
          ...
          <h2 className="TotalNumbers__header Header"><strong className="flames">Burn For Money</strong> <Trans i18nKey="is an internal CSR">is an internal CSR initiative that connects charity with <span className="no-break-space">a fit</span> lifestyle </Trans></h2>
