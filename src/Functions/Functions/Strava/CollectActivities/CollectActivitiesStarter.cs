...
namespace BurnForMoney.Functions.Functions.Strava.CollectActivities
{
    ...
    {
        // at *:55 every day
        [FunctionName(FunctionsNames.Strava_T_CollectStravaActivitiesInEveryHour)]
        ...
        {
            log.LogInformation($"{FunctionsNames.Strava_T_CollectStravaActivitiesInEveryHour} timer trigger processed a request at {DateTime.UtcNow}.");
