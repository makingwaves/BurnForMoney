CREATE TABLE dbo.[Athletes] (Id uniqueidentifier NOT NULL, ExternalId nvarchar(100) UNIQUE, FirstName nvarchar(50), LastName nvarchar(50), ProfilePictureUrl nvarchar(200), Active bit, System nvarchar(30), PRIMARY KEY (Id))
GO

CREATE TABLE dbo.[Activities] (Id uniqueidentifier NOT NULL, AthleteId uniqueidentifier NOT NULL, ExternalId nvarchar(100), ActivityTime datetime2, ActivityType nvarchar(50), Distance int, MovingTime int, Category nvarchar(60), Source nvarchar(30), Points float DEFAULT 0, PRIMARY KEY (Id), FOREIGN KEY (AthleteId) REFERENCES dbo.Athletes(Id))
GO
