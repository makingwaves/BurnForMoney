...
CREATE TABLE dbo.[Strava.AccessTokens] (AthleteId int NOT NULL, AuthorizationCode nvarchar(50), AccessToken nvarchar(100) NOT NULL, RefreshToken nvarchar(100) NOT NULL, ExpiresAt datetime2 NOT NULL, FOREIGN KEY (AthleteId) REFERENCES dbo.[Athletes](Id))
GO
